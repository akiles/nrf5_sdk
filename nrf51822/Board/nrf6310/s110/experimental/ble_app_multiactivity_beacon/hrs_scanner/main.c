...
#define BEACON_FOUND_LED_PIN_NO                 LED_2                                   /**< Is on when when a beacon device is detected. */
 ...
 *          and if they matched the searched one, it lit the LED2. 
 *
...
static void beacon_evt_handler(ble_scan_beacon_evt_t * p_evt)
{
    ...
    {
        nrf_gpio_pin_set(BEACON_FOUND_LED_PIN_NO);
    }
}
...
static void leds_init(void)
{
    ...
    nrf_gpio_cfg_output(BEACON_FOUND_LED_PIN_NO);
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            nrf_gpio_pin_clear(BEACON_FOUND_LED_PIN_NO);
